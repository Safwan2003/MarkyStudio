...
export const PretaaSlot1Intro = ({
    ...
    director?: { layoutPlan: LayoutPlan }
}) => {
    const frame = useCurrentFrame();
    return (
        <AbsoluteFill style={{
            ...
            {director?.layoutPlan?.components && (
                <WidgetRenderer components={director.layoutPlan.components} frame={frame} />
            )}

            {/* Legacy Content (Render only if NOT fully overriding, or underneath) */}
            {/* If Director serves valid plan, we might want to hide legacy elements or mix them */}
            {!director?.layoutPlan && (
                <>
                    ...
                    {/* Avatars */}
                    {/* Avatars */}
                    <Avatar x={25} y={50} color='#fbbf24' delay={10} imgSrc='https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=800&auto=format&fit=crop&q=60' />
                    <Avatar x={45} y={30} color='#ef4444' delay={15} imgSrc='https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=800&auto=format&fit=crop&q=60' />
                    <Avatar x={65} y={35} color='#3b82f6' delay={12} imgSrc='https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=800&auto=format&fit=crop&q=60' />
                    <Avatar x={75} y={60} color='#ec4899' delay={18} imgSrc='https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=800&auto=format&fit=crop&q=60' />
