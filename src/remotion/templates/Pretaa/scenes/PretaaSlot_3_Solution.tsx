...
export const PretaaSlot3Solution = ({
    ...
    director?: { layoutPlan: LayoutPlan; interactionMap?: any }
}) => {
    const frame = useCurrentFrame();
    ...
    return (
        <AbsoluteFill style={{
            ...
            {/* Logo Text Container - Always Visible */}
            <div style={{
            ...
            {/* V4: Scene Director Widgets Overlay - Rendered OUTSIDE Canvas for Remotion context */}
            {director?.layoutPlan && (
                <div style={{
                    position: 'absolute',
                    top: '30%', // Approximate laptop screen position
                    left: '25%',
                    width: '50%',
                    height: '45%',
                    zIndex: 30,
